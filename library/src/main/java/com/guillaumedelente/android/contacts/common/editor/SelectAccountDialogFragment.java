...
package com.guillaumedelente.android.contacts.common.editor;
...
import com.guillaumedelente.android.contacts.common.util.AccountsListAdapter;
...
public final class SelectAccountDialogFragment extends DialogFragment {
    ...
    public static <F extends Fragment & Listener> void show(FragmentManager fragmentManager,
            ...
            AccountsListAdapter.AccountListFilter accountListFilter, Bundle extraArgs) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final AccountsListAdapter.AccountListFilter filter = (AccountsListAdapter.AccountListFilter) args.getSerializable(KEY_LIST_FILTER);
