...
package com.guillaumedelente.android.contacts.common.model;
...
import com.guillaumedelente.android.contacts.common.ContactsUtils;
import com.guillaumedelente.android.contacts.common.model.account.AccountType;
import com.guillaumedelente.android.contacts.common.model.account.GoogleAccountType;
import com.guillaumedelente.android.contacts.common.model.dataitem.DataKind;
import com.guillaumedelente.android.contacts.common.model.dataitem.StructuredNameDataItem;
import com.guillaumedelente.android.contacts.common.util.NameConverter;
import com.guillaumedelente.android.contacts.common.model.dataitem.PhoneDataItem;
import com.guillaumedelente.android.contacts.common.util.CommonDateUtils;
import com.guillaumedelente.android.contacts.common.util.DateUtils;

/**
 * Helper methods for modifying an {@link RawContactDelta}, such as inserting
 * new rows, or enforcing {@link com.guillaumedelente.android.contacts.common.model.account.AccountType}.
 */
public class RawContactModifier {
     ...
     * {@link com.guillaumedelente.android.contacts.common.model.dataitem.DataKind} could be inserted under specific
     * {@link com.guillaumedelente.android.contacts.common.model.account.AccountType}.
     */
     ...
     * list possible {@link com.guillaumedelente.android.contacts.common.model.account.AccountType.EditType} options available based on
     * {@link AccountType}.
     */
     ...
     * {@link AccountType}.
     *
     * @param forceInclude Always include this {@link com.guillaumedelente.android.contacts.common.model.account.AccountType.EditType} in the returned
     *            list, even when an otherwise-invalid choice. This is useful
     *            when showing a dialog that includes the current type.
     */
    public static ArrayList<AccountType.EditType> getValidTypes(RawContactDelta state, DataKind kind,
            AccountType.EditType forceInclude) {
     ...
     *            {@link com.guillaumedelente.android.contacts.common.model.account.AccountType.EditType#secondary}.
     * @param typeCount When provided, will be used for the frequency count of
     *            each {@link com.guillaumedelente.android.contacts.common.model.account.AccountType.EditType}, otherwise built using
    ...
    /**
     * Count up the frequency that each {@link com.guillaumedelente.android.contacts.common.model.account.AccountType.EditType} appears in the given
     * {@link RawContactDelta}. The returned {@link SparseIntArray} maps from
     * {@link com.guillaumedelente.android.contacts.common.model.account.AccountType.EditType#rawValue} to counts, with the total overall count stored
    ...
    /**
     * Find the {@link com.guillaumedelente.android.contacts.common.model.account.AccountType.EditType} that describes the given
    ...
    /**
     * Find the {@link com.guillaumedelente.android.contacts.common.model.account.AccountType.EditType} that describes the given {@link ContentValues} row,
    ...
    /**
     * Find the {@link com.guillaumedelente.android.contacts.common.model.account.AccountType.EditType} that describes the given {@link Cursor} row,
     * assuming the given {@link DataKind} dictates the possible types.
     */
    ...
    /**
     * Find the {@link com.guillaumedelente.android.contacts.common.model.account.AccountType.EditType} with the given {@link com.guillaumedelente.android.contacts.common.model.account.AccountType.EditType#rawValue}.
     */
    ...
    /**
     * Return the precedence for the the given {@link com.guillaumedelente.android.contacts.common.model.account.AccountType.EditType#rawValue}, where
    ...
    /**
     * Find the best {@link com.guillaumedelente.android.contacts.common.model.account.AccountType.EditType} for a potential insert. The "best" is the
     ...
     * {@link RawContactDelta}. Tries using the best {@link com.guillaumedelente.android.contacts.common.model.account.AccountType.EditType} found using
    ...
    /**
     * Insert a new child of kind {@link DataKind} into the given
     * {@link RawContactDelta}, marked with the given {@link com.guillaumedelente.android.contacts.common.model.account.AccountType.EditType}.
     */
     ...
     * or no valid {@link com.guillaumedelente.android.contacts.common.model.account.AccountType.EditType} found.
     *
     * @param typeExtra {@link Bundle} key that holds the incoming
     *            {@link com.guillaumedelente.android.contacts.common.model.account.AccountType.EditType#rawValue} value.
