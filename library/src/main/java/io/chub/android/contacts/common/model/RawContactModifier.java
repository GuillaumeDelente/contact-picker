 ...
 * new rows, or enforcing {@link io.chub.android.contacts.common.model.account.AccountType}.
 */
public class RawContactModifier {
     ...
     * {@link io.chub.android.contacts.common.model.dataitem.DataKind} could be inserted under specific
     * {@link io.chub.android.contacts.common.model.account.AccountType}.
     */
     ...
     * list possible {@link io.chub.android.contacts.common.model.account.AccountType.EditType} options available based on
     * {@link AccountType}.
     */
     ...
     * {@link AccountType}.
     *
     * @param forceInclude Always include this {@link io.chub.android.contacts.common.model.account.AccountType.EditType} in the returned
     ...
     *            {@link io.chub.android.contacts.common.model.account.AccountType.EditType#secondary}.
     * @param typeCount When provided, will be used for the frequency count of
     *            each {@link io.chub.android.contacts.common.model.account.AccountType.EditType}, otherwise built using
    ...
    /**
     * Count up the frequency that each {@link io.chub.android.contacts.common.model.account.AccountType.EditType} appears in the given
     * {@link RawContactDelta}. The returned {@link SparseIntArray} maps from
     * {@link io.chub.android.contacts.common.model.account.AccountType.EditType#rawValue} to counts, with the total overall count stored
    ...
    /**
     * Find the {@link io.chub.android.contacts.common.model.account.AccountType.EditType} that describes the given
    ...
    /**
     * Find the {@link io.chub.android.contacts.common.model.account.AccountType.EditType} that describes the given {@link ContentValues} row,
    ...
    /**
     * Find the {@link io.chub.android.contacts.common.model.account.AccountType.EditType} that describes the given {@link Cursor} row,
     * assuming the given {@link DataKind} dictates the possible types.
     */
    ...
    /**
     * Find the {@link io.chub.android.contacts.common.model.account.AccountType.EditType} with the given {@link io.chub.android.contacts.common.model.account.AccountType.EditType#rawValue}.
     */
    ...
    /**
     * Return the precedence for the the given {@link io.chub.android.contacts.common.model.account.AccountType.EditType#rawValue}, where
    ...
    /**
     * Find the best {@link io.chub.android.contacts.common.model.account.AccountType.EditType} for a potential insert. The "best" is the
     ...
     * {@link RawContactDelta}. Tries using the best {@link io.chub.android.contacts.common.model.account.AccountType.EditType} found using
    ...
    /**
     * Insert a new child of kind {@link DataKind} into the given
     * {@link RawContactDelta}, marked with the given {@link io.chub.android.contacts.common.model.account.AccountType.EditType}.
     */
     ...
     * or no valid {@link io.chub.android.contacts.common.model.account.AccountType.EditType} found.
     *
     * @param typeExtra {@link Bundle} key that holds the incoming
     *            {@link io.chub.android.contacts.common.model.account.AccountType.EditType#rawValue} value.
