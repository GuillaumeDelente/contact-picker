...
package com.guillaumedelente.android.contacts.common.extensions;

import android.content.Context;

import java.util.List;

import com.guillaumedelente.android.contacts.common.list.DirectoryPartition;

/**
 * An interface for adding extended phone directories to
 * {@link com.guillaumedelente.android.contacts.common.list.PhoneNumberListAdapter}.
